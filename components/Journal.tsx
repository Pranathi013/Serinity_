...
const GamesScreen: React.FC = () => {
    ...
    const handleGameWin = useCallback((gameId: string) => {
        ...
        if (game && !['breathing-bubbles', 'mood-melody', 'gratitude-garden'].includes(game.id)) {
    ...
    const relaxationGames = games.filter(g => ['breathing-bubbles', 'mood-melody', 'gratitude-garden'].includes(g.id));
    const challengeGames = games.filter(g => !['breathing-bubbles', 'mood-melody', 'gratitude-garden'].includes(g.id));
